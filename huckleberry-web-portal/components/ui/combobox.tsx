...
function ComboboxAnchor({
  ...
  return (
    <ComboboxPrimitive.Anchor
      ...
      className={cn(
        "relative flex h-9 w-full items-center justify-between gap-2 rounded-md border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-3 py-2 shadow-xs focus-within:ring-2 focus-within:ring-indigo-500 dark:focus-within:ring-indigo-400 focus-within:border-indigo-500 dark:focus-within:border-indigo-400",
        className,
      )}
      {...props}
    />
...
function ComboboxInput({
  ...
  return (
    <ComboboxPrimitive.Input
      ...
      className={cn(
        "flex h-full w-full flex-1 bg-transparent text-base placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm border-0 ring-0",
        className,
      )}
      {...props}
    />
...
function ComboboxCancel({
  ...
  return (
    <ComboboxPrimitive.Cancel
      ...
      className={cn(
        "flex shrink-0 size-5 items-center justify-center rounded-sm text-gray-500 dark:text-neutral-400 opacity-70 ring-offset-background transition-opacity hover:opacity-100 hover:text-gray-700 dark:hover:text-neutral-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:ring-offset-2 disabled:pointer-events-none",
        className,
      )}
      {...props}
    >
